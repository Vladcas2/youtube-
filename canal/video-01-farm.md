# Video 1 — Farm Animal Sounds Quiz (engleză)

> Structura e cea a donorului (intro 3 s → 20 de runde de ~25 s → final), cu timpii lui.
> Textul, subiectul, desenul și vocea sunt ale noastre.
> ⚠️ Interiorul unei runde e presupus (n-am transcrierea donorului). Uită-te la o rundă din donor și confirmă.
...
```
Put on your listening ears! 🦉 Pip the owl plays 20 farm animal sounds. Can your
little one name them all before the countdown ends?

🎧 Hear real farm animal sounds
🐮 Learn 20 farm animal names
...
| | |
|---|---|
| Fundal | galben plin #FFD23F, fără peisaj |
| Stânga (40%) | Pip, mare, cu aripa la ureche, gura deschisă de mirare |
| Centru-dreapta | **silueta neagră a unei vaci** cu un „?” alb uriaș |
| Text | **WHO SAID MOO?**: 3 cuvinte, alb, contur gros închis, sus |
| Colț dreapta-jos | cerc coral cu „20” |
| Contrast | negru pe galben (siluetă) + alb pe galben cu contur închis (text) |

**Cu ce diferă față de donor:** donorul are 3D, junglă plină de detalii, mai multe animale colorate
și titlul 3D curcubeu. Al nostru: 2D plat, fundal gol, **un singur animal și acela ascuns**.
Curiozitatea vine din ce nu se vede.

Prompt (textul îl adaugi în Canva):
```
...
## 3. Primele 30 de secunde: textul exact
...
## 4. Planul pe blocuri (aceeași ordine ca la donor)
...
| 5. Final | 8:28–8:40 | recapitulare + trimitere spre video 2 | închide bucla „all twenty” și dă imediat următorul joc |

---

## 5. Textul complet: rundă cu rundă
...
| Voce | Ecran |
|---|---|
| **"You did it! All twenty animals!"** | toate cele 20 de animale apar în grilă, rând pe rând |
| **"You are a SUPER listener!"** | Pip primește o medalie |
| **"Want more? Let's go to the ocean next! See you there!"** | end screen: video 2 (animale din ocean) + buton abonare |

Până ai video 2, pune în end screen „cel mai recent videoclip”.

---

## 6. Scene și prompturi

Pentru fiecare rundă folosești **promptul A (silueta)** și **promptul B (dezvăluirea)** din
`profil-canal.md`, Pasul 6. Schimbi doar [ANIMAL]. Pentru bufniță, greier și porumbel schimbă
„farmyard” cu „barn at night”, „tall grass” și „barn roof”.

**Scena de intro (0:00–0:03):**
```
Pip, a small round coral-orange baby owl with big mint-green eyes and oversized
...
- **Ritm:** lent și clar, ~130 de cuvinte/minut. Copiii de 2–4 ani nu țin pasul cu vorbitul rapid.
- **Ton:** cald, entuziast, ca un educator de grădiniță, nu ca un prezentator TV.
- **Pauze:** tăcere completă cât se aude sunetul animalului (nicio muzică peste el) și o pauză de ~0,5 s înainte de „It's a…”.
- **Accent pe:** numele animalului (COW, PIG…), „ALL twenty” din intro și „hardest ones” din runda 16.
- **Numărătoarea:** tot mai încet și mai în șoaptă, iar „one…” aproape șoptit, ca dezvăluirea să explodeze.
- Voce AI: ElevenLabs sau altă voce caldă și clară. Folosește aceeași voce în toate videoclipurile, face parte din identitatea canalului.
- Muzică de fundal: veselă, foarte încet (−25 dB), oprită în timpul sunetelor animalelor.

---

## 8. Ce e diferit față de donor
